...
export const filterAffairs = (affairs: Array<AffairType>, filter: 'all' | AffairPriorityType): Array<AffairType> => {
    if (filter === 'all') {
        return affairs
    } else if (filter === 'high') {
...
export const deleteAffair = (affairs: Array<AffairType>, _id: number): Array<AffairType> => {
    let remainAffairs = affairs.filter(affair => affair._id !== _id)
    return remainAffairs
};
